...
namespace AirMonitor.ViewModels
{
    class DetailsViewModel
    {
        ...
        private string _caqiTitle = "Świetnna jakość!";
        ...
        private string _caqiDescription = "Możeszz bezpiecznie wyjść z domu bez swojej maski anty-smogowej i nie bać się o swoje zdrowie.";
